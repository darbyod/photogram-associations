...
class User < ApplicationRecord
  ...
  has_many(:accepted_sent_follow_requests, through: :sent_follow_requests, source: :sent_follow_requests )
  has_many(:accepted_received_follow_requests, class_name: "FollowRequest", foreign_key: "sender_id")
  ...
  has_many(:followers, through: :accepted_received_follow_requests, source: :sender )
  has_many(:leaders, through: :accepted_received_follow_requests, source: :recipient )
